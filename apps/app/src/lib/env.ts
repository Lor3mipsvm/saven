...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_CB_PROJECT_ID: z.string().min(1),
    NEXT_PUBLIC_CB_PUBLIC_API_KEY: z.string().min(1),
    NEXT_PUBLIC_BASE_RPC_URL: z.string().min(1)
  ...
  experimental__runtimeEnv: {
    ...
    NEXT_PUBLIC_CB_PROJECT_ID: process.env.NEXT_PUBLIC_CB_PROJECT_ID,
    NEXT_PUBLIC_CB_PUBLIC_API_KEY: process.env.NEXT_PUBLIC_CB_PUBLIC_API_KEY,
